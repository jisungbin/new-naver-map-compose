...
import land.sungbin.navermap.ui.modifier.circleoverlay.CircleOverlayModifier
import land.sungbin.navermap.ui.modifier.delegator.LocalCircleOverlayDelegator

/**
 * See
 * [official document](https://navermaps.github.io/android-map-sdk/reference/com/naver/maps/map/overlay/CircleOverlay.html)
 */
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.CircleOverlay(modifier: CircleOverlayModifier = CircleOverlayModifier) {
  val delegator: CircleOverlayDelegate = LocalCircleOverlayDelegator.current
      ...
      OverlayNode(
        ...
        factory = {
          object : OverlayDelegator {
            override val instance: Any = com.naver.maps.map.overlay.CircleOverlay()
...
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.CircleOverlay(
  arg0: LatLng,
  arg1: Double,
  modifier: CircleOverlayModifier = CircleOverlayModifier,
) {
  val delegator: CircleOverlayDelegate = LocalCircleOverlayDelegator.current
...
@Stable
private fun CircleOverlayModifier.toMapModifier(delegator: CircleOverlayDelegate): MapModifier =
