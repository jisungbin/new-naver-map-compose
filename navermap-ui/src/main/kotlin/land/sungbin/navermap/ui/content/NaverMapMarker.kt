...
import land.sungbin.navermap.ui.modifier.delegator.LocalMarkerDelegator
...
/**
 * See
 * [official document](https://navermaps.github.io/android-map-sdk/reference/com/naver/maps/map/overlay/Marker.html)
 */
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.Marker(modifier: MarkerModifier = MarkerModifier) {
  val delegator: MarkerDelegate = LocalMarkerDelegator.current
      ...
      OverlayNode(
        ...
        factory = {
          object : OverlayDelegator {
            override val instance: Any = com.naver.maps.map.overlay.Marker()
...
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.Marker(arg0: LatLng, modifier: MarkerModifier = MarkerModifier) {
  val delegator: MarkerDelegate = LocalMarkerDelegator.current
...
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.Marker(arg0: OverlayImage, modifier: MarkerModifier = MarkerModifier) {
  val delegator: MarkerDelegate = LocalMarkerDelegator.current
...
@Composable
@Suppress("UnusedReceiverParameter")
public fun NaverMapContent.Marker(
  arg0: LatLng,
  arg1: OverlayImage,
  modifier: MarkerModifier = MarkerModifier,
) {
  val delegator: MarkerDelegate = LocalMarkerDelegator.current
...
@Stable
private fun MarkerModifier.toMapModifier(delegator: MarkerDelegate): MapModifier =
