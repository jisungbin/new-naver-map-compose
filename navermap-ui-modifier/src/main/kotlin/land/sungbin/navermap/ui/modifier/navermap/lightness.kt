...
@Stable
private data class NaverMapLightnessModifierNode(
  private val arg0: Float,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapLightnessContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapLightnessContributionNode(
  public val arg0: Float,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapLightnessContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapLightnessContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapLightnessContributor(
  public var arg0: Float,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setLightness(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.lightness(arg0: Float): NaverMapModifier =
  this then NaverMapLightnessModifierNode(arg0)
