...
@Stable
private data class MarkerCaptionTextModifierNode(
  private val arg0: String,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerCaptionTextContributionNode(arg0, delegator)
...
@Stable
private data class MarkerCaptionTextContributionNode(
  public val arg0: String,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerCaptionTextContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerCaptionTextContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerCaptionTextContributor(
  public var arg0: String,
  public var `delegate`: MarkerDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setCaptionText(this, arg0)
  }
}
 ...
 */
@Stable
public fun MarkerModifier.captionText(arg0: String): MarkerModifier =
  this then MarkerCaptionTextModifierNode(arg0)
