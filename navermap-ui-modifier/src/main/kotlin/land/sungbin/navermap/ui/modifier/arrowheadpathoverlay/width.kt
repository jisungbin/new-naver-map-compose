...
@Stable
private data class ArrowheadPathOverlayWidthContributionNode(
  public val arg0: Int,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayWidthContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayWidthContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ArrowheadPathOverlayWidthContributor(
  public var arg0: Int,
  public var `delegate`: ArrowheadPathOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setWidth(this, arg0)
  }
}
 ...
 */
@Stable
public fun ArrowheadPathOverlayModifier.width(arg0: Int): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayWidthModifierNode(arg0)
