...
@Stable
private data class NaverMapLocaleModifierNode(
  private val arg0: Locale?,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapLocaleContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapLocaleContributionNode(
  public val arg0: Locale?,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapLocaleContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapLocaleContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is NaverMapLocaleContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class NaverMapLocaleContributor(
  public var arg0: Locale?,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  public var clear: (() -> Unit)? = null

  override fun Any.contribute() {
    delegate.setLocale(this, arg0)
    clear = { delegate.setLocale(this, null) }
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.locale(arg0: Locale?): NaverMapModifier =
  this then NaverMapLocaleModifierNode(arg0)
