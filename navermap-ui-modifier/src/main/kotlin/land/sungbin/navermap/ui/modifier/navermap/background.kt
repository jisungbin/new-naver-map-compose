...
@Stable
private data class NaverMapBackgroundModifierNode(
  private val arg0: Drawable?,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapBackgroundContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapBackgroundContributionNode(
  public val arg0: Drawable?,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapBackgroundContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapBackgroundContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is NaverMapBackgroundContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class NaverMapBackgroundContributor(
  public var arg0: Drawable?,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  public var clear: (() -> Unit)? = null

  override fun Any.contribute() {
    delegate.setBackground(this, arg0)
    clear = { delegate.setBackground(this, null) }
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.background(arg0: Drawable?): NaverMapModifier =
  this then NaverMapBackgroundModifierNode(arg0)
