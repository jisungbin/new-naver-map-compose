...
@Stable
private data class PolygonOverlayMaxZoomInclusiveModifierNode(
  private val arg0: Boolean,
  override var delegator: PolygonOverlayDelegate = NoOp,
) : PolygonOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    PolygonOverlayMaxZoomInclusiveContributionNode(arg0, delegator)
...
@Stable
private data class PolygonOverlayMaxZoomInclusiveContributionNode(
  public val arg0: Boolean,
  public val `delegate`: PolygonOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolygonOverlayMaxZoomInclusiveContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolygonOverlayMaxZoomInclusiveContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolygonOverlayMaxZoomInclusiveContributor(
 ...
 */
@Stable
public fun PolygonOverlayModifier.maxZoomInclusive(arg0: Boolean): PolygonOverlayModifier =
  this then PolygonOverlayMaxZoomInclusiveModifierNode(arg0)
