...
@Stable
private data class LocationOverlayIconContributionNode(
  public val arg0: OverlayImage,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayIconContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayIconContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayIconContributor(
  public var arg0: OverlayImage,
  public var `delegate`: LocationOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setIcon(this, arg0)
  }
}
 ...
 */
@Stable
public fun LocationOverlayModifier.icon(arg0: OverlayImage): LocationOverlayModifier =
  this then LocationOverlayIconModifierNode(arg0)
