...
@Stable
private data class NaverMapNightModeEnabledModifierNode(
  private val arg0: Boolean,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapNightModeEnabledContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapNightModeEnabledContributionNode(
  public val arg0: Boolean,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapNightModeEnabledContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapNightModeEnabledContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapNightModeEnabledContributor(
  public var arg0: Boolean,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setNightModeEnabled(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.nightModeEnabled(arg0: Boolean): NaverMapModifier =
  this then NaverMapNightModeEnabledModifierNode(arg0)
