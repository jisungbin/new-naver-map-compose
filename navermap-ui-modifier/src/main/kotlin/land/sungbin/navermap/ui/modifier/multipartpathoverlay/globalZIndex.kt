...
@Stable
private data class MultipartPathOverlayGlobalZIndexModifierNode(
  private val arg0: Int,
  override var delegator: MultipartPathOverlayDelegate = NoOp,
) : MultipartPathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MultipartPathOverlayGlobalZIndexContributionNode(arg0, delegator)
...
@Stable
private data class MultipartPathOverlayGlobalZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: MultipartPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MultipartPathOverlayGlobalZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayGlobalZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MultipartPathOverlayGlobalZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun MultipartPathOverlayModifier.globalZIndex(arg0: Int): MultipartPathOverlayModifier =
  this then MultipartPathOverlayGlobalZIndexModifierNode(arg0)
