...
@Stable
private data class NaverMapExtentModifierNode(
  private val arg0: LatLngBounds?,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapExtentContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapExtentContributionNode(
  public val arg0: LatLngBounds?,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapExtentContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapExtentContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is NaverMapExtentContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class NaverMapExtentContributor(
  ...
  override fun Any.contribute() {
    delegate.setExtent(this, arg0)
    clear = { delegate.setExtent(this, null) }
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.extent(arg0: LatLngBounds?): NaverMapModifier =
  this then NaverMapExtentModifierNode(arg0)
