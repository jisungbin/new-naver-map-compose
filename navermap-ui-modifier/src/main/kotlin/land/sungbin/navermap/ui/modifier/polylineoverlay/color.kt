...
@Stable
private data class PolylineOverlayColorContributionNode(
  public val arg0: Int,
  public val `delegate`: PolylineOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolylineOverlayColorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolylineOverlayColorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolylineOverlayColorContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun PolylineOverlayModifier.color(arg0: Int): PolylineOverlayModifier =
  this then PolylineOverlayColorModifierNode(arg0)
