...
@Stable
private data class NaverMapMaxTiltModifierNode(
  private val arg0: Double,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapMaxTiltContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapMaxTiltContributionNode(
  public val arg0: Double,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapMaxTiltContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapMaxTiltContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapMaxTiltContributor(
  public var arg0: Double,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setMaxTilt(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.maxTilt(arg0: Double): NaverMapModifier =
  this then NaverMapMaxTiltModifierNode(arg0)
