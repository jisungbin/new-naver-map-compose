...
@Stable
private data class GroundOverlayImageContributionNode(
  public val arg0: OverlayImage,
  public val `delegate`: GroundOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = GroundOverlayImageContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is GroundOverlayImageContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class GroundOverlayImageContributor(
...
@Stable
public fun GroundOverlayModifier.image(arg0: OverlayImage): GroundOverlayModifier =
  this then GroundOverlayImageModifierNode(arg0)
