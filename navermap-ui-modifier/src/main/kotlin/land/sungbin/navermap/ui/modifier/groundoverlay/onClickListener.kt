...
@Immutable
private data class GroundOverlayOnClickListenerModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    GroundOverlayOnClickListenerContributionNode(arg0, delegator)
...
@Stable
private data class GroundOverlayOnClickListenerContributionNode(
  ...
  override fun create(): Contributor = GroundOverlayOnClickListenerContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is GroundOverlayOnClickListenerContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is GroundOverlayOnClickListenerContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class GroundOverlayOnClickListenerContributor(
...
@Stable
public fun GroundOverlayModifier.onClickListener(arg0: Overlay.OnClickListener?): GroundOverlayModifier = this then GroundOverlayOnClickListenerModifierNode(arg0)
