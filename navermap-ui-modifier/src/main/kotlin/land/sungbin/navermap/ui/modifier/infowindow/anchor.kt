...
private data class InfoWindowAnchorModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    InfoWindowAnchorContributionNode(arg0, delegator)
...
@Stable
private data class InfoWindowAnchorContributionNode(
  public val arg0: PointF,
  public val `delegate`: InfoWindowDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = InfoWindowAnchorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is InfoWindowAnchorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class InfoWindowAnchorContributor(
