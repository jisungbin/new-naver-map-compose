...
@Stable
private data class MultipartPathOverlayMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: MultipartPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MultipartPathOverlayMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MultipartPathOverlayMaxZoomContributor(
...
@Stable
public fun MultipartPathOverlayModifier.maxZoom(arg0: Double): MultipartPathOverlayModifier =
  this then MultipartPathOverlayMaxZoomModifierNode(arg0)
