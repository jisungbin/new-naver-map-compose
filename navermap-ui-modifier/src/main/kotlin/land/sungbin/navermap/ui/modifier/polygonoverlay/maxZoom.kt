...
@Stable
private data class PolygonOverlayMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: PolygonOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolygonOverlayMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolygonOverlayMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolygonOverlayMaxZoomContributor(
...
@Stable
public fun PolygonOverlayModifier.maxZoom(arg0: Double): PolygonOverlayModifier =
  this then PolygonOverlayMaxZoomModifierNode(arg0)
