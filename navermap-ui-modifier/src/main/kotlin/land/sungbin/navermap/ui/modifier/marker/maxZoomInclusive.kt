...
@Stable
private data class MarkerMaxZoomInclusiveModifierNode(
  private val arg0: Boolean,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerMaxZoomInclusiveContributionNode(arg0, delegator)
...
@Stable
private data class MarkerMaxZoomInclusiveContributionNode(
  public val arg0: Boolean,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerMaxZoomInclusiveContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerMaxZoomInclusiveContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerMaxZoomInclusiveContributor(
 ...
 */
@Stable
public fun MarkerModifier.maxZoomInclusive(arg0: Boolean): MarkerModifier =
  this then MarkerMaxZoomInclusiveModifierNode(arg0)
