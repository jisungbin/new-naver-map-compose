...
private data class ViewportOverlayMinZoomModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    ViewportOverlayMinZoomContributionNode(arg0, delegator)
...
@Stable
private data class ViewportOverlayMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: ViewportOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ViewportOverlayMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ViewportOverlayMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ViewportOverlayMinZoomContributor(
