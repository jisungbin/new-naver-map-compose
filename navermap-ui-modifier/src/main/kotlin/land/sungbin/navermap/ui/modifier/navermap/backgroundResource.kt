...
@Stable
private data class NaverMapBackgroundResourceModifierNode(
  private val arg0: Int,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapBackgroundResourceContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapBackgroundResourceContributionNode(
  public val arg0: Int,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapBackgroundResourceContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapBackgroundResourceContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapBackgroundResourceContributor(
  public var arg0: Int,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setBackgroundResource(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.backgroundResource(arg0: Int): NaverMapModifier =
  this then NaverMapBackgroundResourceModifierNode(arg0)
