...
@Stable
private data class LocationOverlayTagContributionNode(
  public val arg0: Any?,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayTagContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayTagContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is LocationOverlayTagContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class LocationOverlayTagContributor(
  public var arg0: Any?,
 ...
 */
@Stable
public fun LocationOverlayModifier.tag(arg0: Any?): LocationOverlayModifier =
  this then LocationOverlayTagModifierNode(arg0)
