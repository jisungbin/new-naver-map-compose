...
@Stable
private data class NaverMapCameraIdlePendingModifierNode(
  private val arg0: Boolean,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapCameraIdlePendingContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapCameraIdlePendingContributionNode(
  public val arg0: Boolean,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapCameraIdlePendingContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapCameraIdlePendingContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapCameraIdlePendingContributor(
  public var arg0: Boolean,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setCameraIdlePending(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.cameraIdlePending(arg0: Boolean): NaverMapModifier =
  this then NaverMapCameraIdlePendingModifierNode(arg0)
