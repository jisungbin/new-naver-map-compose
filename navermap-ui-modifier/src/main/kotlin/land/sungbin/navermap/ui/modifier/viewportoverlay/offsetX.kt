...
@Stable
private data class ViewportOverlayOffsetXModifierNode(
  private val arg0: Int,
  override var delegator: ViewportOverlayDelegate = NoOp,
) : ViewportOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    ViewportOverlayOffsetXContributionNode(arg0, delegator)
...
@Stable
private data class ViewportOverlayOffsetXContributionNode(
  public val arg0: Int,
  public val `delegate`: ViewportOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ViewportOverlayOffsetXContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ViewportOverlayOffsetXContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ViewportOverlayOffsetXContributor(
  public var arg0: Int,
  public var `delegate`: ViewportOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setOffsetX(this, arg0)
  }
}
 ...
 */
@Stable
public fun ViewportOverlayModifier.offsetX(arg0: Int): ViewportOverlayModifier =
  this then ViewportOverlayOffsetXModifierNode(arg0)
