...
@Stable
private data class CircleOverlayOutlineColorModifierNode(
  private val arg0: Int,
  override var delegator: CircleOverlayDelegate = NoOp,
) : CircleOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    CircleOverlayOutlineColorContributionNode(arg0, delegator)
...
@Stable
private data class CircleOverlayOutlineColorContributionNode(
  public val arg0: Int,
  public val `delegate`: CircleOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = CircleOverlayOutlineColorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is CircleOverlayOutlineColorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class CircleOverlayOutlineColorContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun CircleOverlayModifier.outlineColor(arg0: Int): CircleOverlayModifier =
  this then CircleOverlayOutlineColorModifierNode(arg0)
