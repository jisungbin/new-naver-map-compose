...
@Stable
private data class ViewportOverlayWidthContributionNode(
  public val arg0: Int,
  public val `delegate`: ViewportOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ViewportOverlayWidthContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ViewportOverlayWidthContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ViewportOverlayWidthContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun ViewportOverlayModifier.width(arg0: Int): ViewportOverlayModifier =
  this then ViewportOverlayWidthModifierNode(arg0)
