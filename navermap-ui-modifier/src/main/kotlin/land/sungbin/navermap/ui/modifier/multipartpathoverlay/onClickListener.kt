...
@Stable
private data class MultipartPathOverlayOnClickListenerModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    MultipartPathOverlayOnClickListenerContributionNode(arg0, delegator)
...
@Stable
private data class MultipartPathOverlayOnClickListenerContributionNode(
  ...
  override fun create(): Contributor = MultipartPathOverlayOnClickListenerContributor(
    arg0,
    delegate,
  )

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayOnClickListenerContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is MultipartPathOverlayOnClickListenerContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class MultipartPathOverlayOnClickListenerContributor(
 ...
 */
@Stable
public fun MultipartPathOverlayModifier.onClickListener(arg0: Overlay.OnClickListener?): MultipartPathOverlayModifier = this then MultipartPathOverlayOnClickListenerModifierNode(arg0)
