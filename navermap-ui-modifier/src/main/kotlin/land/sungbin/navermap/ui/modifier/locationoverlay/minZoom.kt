...
@Stable
private data class LocationOverlayMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayMinZoomContributor(
...
@Stable
public fun LocationOverlayModifier.minZoom(arg0: Double): LocationOverlayModifier =
  this then LocationOverlayMinZoomModifierNode(arg0)
