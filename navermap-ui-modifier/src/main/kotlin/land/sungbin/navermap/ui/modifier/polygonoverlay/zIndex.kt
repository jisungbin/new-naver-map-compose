...
@Stable
private data class PolygonOverlayZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: PolygonOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolygonOverlayZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolygonOverlayZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolygonOverlayZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun PolygonOverlayModifier.zIndex(arg0: Int): PolygonOverlayModifier =
  this then PolygonOverlayZIndexModifierNode(arg0)
