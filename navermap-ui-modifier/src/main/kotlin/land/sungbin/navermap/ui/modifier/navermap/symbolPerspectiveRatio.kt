...
@Stable
private data class NaverMapSymbolPerspectiveRatioModifierNode(
  private val arg0: Float,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapSymbolPerspectiveRatioContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapSymbolPerspectiveRatioContributionNode(
  public val arg0: Float,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapSymbolPerspectiveRatioContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapSymbolPerspectiveRatioContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapSymbolPerspectiveRatioContributor(
  public var arg0: Float,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setSymbolPerspectiveRatio(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.symbolPerspectiveRatio(arg0: Float): NaverMapModifier =
  this then NaverMapSymbolPerspectiveRatioModifierNode(arg0)
