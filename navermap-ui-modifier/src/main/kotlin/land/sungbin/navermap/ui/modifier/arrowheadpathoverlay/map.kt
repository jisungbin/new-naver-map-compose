...
private data class ArrowheadPathOverlayMapModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    ArrowheadPathOverlayMapContributionNode(arg0, delegator)
...
@Stable
private data class ArrowheadPathOverlayMapContributionNode(
  public val arg0: NaverMap?,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayMapContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayMapContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is ArrowheadPathOverlayMapContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class ArrowheadPathOverlayMapContributor(
