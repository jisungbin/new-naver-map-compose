...
@Stable
private data class NaverMapFpsLimitModifierNode(
  private val arg0: Int,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapFpsLimitContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapFpsLimitContributionNode(
  public val arg0: Int,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapFpsLimitContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapFpsLimitContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapFpsLimitContributor(
  public var arg0: Int,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setFpsLimit(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.fpsLimit(arg0: Int): NaverMapModifier =
  this then NaverMapFpsLimitModifierNode(arg0)
