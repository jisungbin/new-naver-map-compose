...
@Stable
private data class PathOverlayGlobalZIndexModifierNode(
  private val arg0: Int,
  override var delegator: PathOverlayDelegate = NoOp,
) : PathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    PathOverlayGlobalZIndexContributionNode(arg0, delegator)
...
@Stable
private data class PathOverlayGlobalZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: PathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PathOverlayGlobalZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PathOverlayGlobalZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PathOverlayGlobalZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun PathOverlayModifier.globalZIndex(arg0: Int): PathOverlayModifier =
  this then PathOverlayGlobalZIndexModifierNode(arg0)
