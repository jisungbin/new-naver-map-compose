...
@Stable
private data class NaverMapMinZoomModifierNode(
  private val arg0: Double,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapMinZoomContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapMinZoomContributor(
 ...
 */
@Stable
public fun NaverMapModifier.minZoom(arg0: Double): NaverMapModifier =
  this then NaverMapMinZoomModifierNode(arg0)
