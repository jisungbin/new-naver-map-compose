...
@Stable
private data class LocationOverlayAnchorContributionNode(
  public val arg0: PointF,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayAnchorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayAnchorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayAnchorContributor(
...
@Stable
public fun LocationOverlayModifier.anchor(arg0: PointF): LocationOverlayModifier =
  this then LocationOverlayAnchorModifierNode(arg0)
