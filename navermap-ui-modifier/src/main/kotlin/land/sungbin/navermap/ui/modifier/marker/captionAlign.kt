...
private data class MarkerCaptionAlignModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerCaptionAlignContributionNode(arg0, delegator)
...
@Stable
private data class MarkerCaptionAlignContributionNode(
  public val arg0: Align,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerCaptionAlignContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerCaptionAlignContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerCaptionAlignContributor(
  public var arg0: Align,
  public var `delegate`: MarkerDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setCaptionAlign(this, arg0)
  }
}
