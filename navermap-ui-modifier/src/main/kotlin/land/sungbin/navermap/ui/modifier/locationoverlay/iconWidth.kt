...
@Stable
private data class LocationOverlayIconWidthModifierNode(
  private val arg0: Int,
  override var delegator: LocationOverlayDelegate = NoOp,
) : LocationOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    LocationOverlayIconWidthContributionNode(arg0, delegator)
...
@Stable
private data class LocationOverlayIconWidthContributionNode(
  public val arg0: Int,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayIconWidthContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayIconWidthContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayIconWidthContributor(
  public var arg0: Int,
  public var `delegate`: LocationOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setIconWidth(this, arg0)
  }
}
 ...
 */
@Stable
public fun LocationOverlayModifier.iconWidth(arg0: Int): LocationOverlayModifier =
  this then LocationOverlayIconWidthModifierNode(arg0)
