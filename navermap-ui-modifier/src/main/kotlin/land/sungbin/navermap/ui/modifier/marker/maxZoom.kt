...
@Immutable
private data class MarkerMaxZoomModifierNode(
  private val arg0: Double,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerMaxZoomContributionNode(arg0, delegator)
...
@Stable
private data class MarkerMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerMaxZoomContributor(
...
@Stable
public fun MarkerModifier.maxZoom(arg0: Double): MarkerModifier =
  this then MarkerMaxZoomModifierNode(arg0)
