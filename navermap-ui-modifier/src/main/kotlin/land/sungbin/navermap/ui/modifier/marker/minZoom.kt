...
@Immutable
private data class MarkerMinZoomModifierNode(
  private val arg0: Double,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerMinZoomContributionNode(arg0, delegator)
...
@Stable
private data class MarkerMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerMinZoomContributor(
...
@Stable
public fun MarkerModifier.minZoom(arg0: Double): MarkerModifier =
  this then MarkerMinZoomModifierNode(arg0)
