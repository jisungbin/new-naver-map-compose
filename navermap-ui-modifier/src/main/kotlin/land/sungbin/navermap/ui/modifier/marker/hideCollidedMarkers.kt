...
@Stable
private data class MarkerHideCollidedMarkersModifierNode(
  private val arg0: Boolean,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerHideCollidedMarkersContributionNode(arg0, delegator)
...
@Stable
private data class MarkerHideCollidedMarkersContributionNode(
  public val arg0: Boolean,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerHideCollidedMarkersContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerHideCollidedMarkersContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerHideCollidedMarkersContributor(
 ...
 */
@Stable
public fun MarkerModifier.hideCollidedMarkers(arg0: Boolean): MarkerModifier =
  this then MarkerHideCollidedMarkersModifierNode(arg0)
