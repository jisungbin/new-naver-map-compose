...
@Stable
private data class NaverMapBackgroundBitmapModifierNode(
  private val arg0: Bitmap?,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapBackgroundBitmapContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapBackgroundBitmapContributionNode(
  public val arg0: Bitmap?,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapBackgroundBitmapContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapBackgroundBitmapContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is NaverMapBackgroundBitmapContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class NaverMapBackgroundBitmapContributor(
  public var arg0: Bitmap?,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  public var clear: (() -> Unit)? = null

  override fun Any.contribute() {
    delegate.setBackgroundBitmap(this, arg0)
    clear = { delegate.setBackgroundBitmap(this, null) }
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.backgroundBitmap(arg0: Bitmap?): NaverMapModifier =
  this then NaverMapBackgroundBitmapModifierNode(arg0)
