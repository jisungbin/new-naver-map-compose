...
@Stable
private data class MultipartPathOverlayMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: MultipartPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MultipartPathOverlayMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MultipartPathOverlayMinZoomContributor(
 ...
 */
@Stable
public fun MultipartPathOverlayModifier.minZoom(arg0: Double): MultipartPathOverlayModifier =
  this then MultipartPathOverlayMinZoomModifierNode(arg0)
