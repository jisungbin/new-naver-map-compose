...
@Stable
private data class ArrowheadPathOverlayTagContributionNode(
  public val arg0: Any?,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayTagContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayTagContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is ArrowheadPathOverlayTagContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class ArrowheadPathOverlayTagContributor(
  public var arg0: Any?,
...
@Stable
public fun ArrowheadPathOverlayModifier.tag(arg0: Any?): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayTagModifierNode(arg0)
