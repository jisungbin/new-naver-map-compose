...
@Stable
private data class NaverMapIndoorFocusRadiusModifierNode(
  private val arg0: Int,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapIndoorFocusRadiusContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapIndoorFocusRadiusContributionNode(
  public val arg0: Int,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapIndoorFocusRadiusContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapIndoorFocusRadiusContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapIndoorFocusRadiusContributor(
  public var arg0: Int,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setIndoorFocusRadius(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.indoorFocusRadius(arg0: Int): NaverMapModifier =
  this then NaverMapIndoorFocusRadiusModifierNode(arg0)
