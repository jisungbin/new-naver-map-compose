...
@Stable
private data class ArrowheadPathOverlayOutlineColorModifierNode(
  private val arg0: Int,
  override var delegator: ArrowheadPathOverlayDelegate = NoOp,
) : ArrowheadPathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    ArrowheadPathOverlayOutlineColorContributionNode(arg0, delegator)
...
@Stable
private data class ArrowheadPathOverlayOutlineColorContributionNode(
  public val arg0: Int,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayOutlineColorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayOutlineColorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ArrowheadPathOverlayOutlineColorContributor(
  public var arg0: Int,
  public var `delegate`: ArrowheadPathOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setOutlineColor(this, arg0)
  }
}
 ...
 */
@Stable
public fun ArrowheadPathOverlayModifier.outlineColor(arg0: Int): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayOutlineColorModifierNode(arg0)
