...
@Stable
private data class ViewportOverlayMinZoomInclusiveModifierNode(
  private val arg0: Boolean,
  override var delegator: ViewportOverlayDelegate = NoOp,
) : ViewportOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    ViewportOverlayMinZoomInclusiveContributionNode(arg0, delegator)
...
@Stable
private data class ViewportOverlayMinZoomInclusiveContributionNode(
  public val arg0: Boolean,
  public val `delegate`: ViewportOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ViewportOverlayMinZoomInclusiveContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ViewportOverlayMinZoomInclusiveContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ViewportOverlayMinZoomInclusiveContributor(
 ...
 */
@Stable
public fun ViewportOverlayModifier.minZoomInclusive(arg0: Boolean): ViewportOverlayModifier =
  this then ViewportOverlayMinZoomInclusiveModifierNode(arg0)
