...
private data class MarkerAngleModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerAngleContributionNode(arg0, delegator)
...
@Stable
private data class MarkerAngleContributionNode(
  public val arg0: Float,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerAngleContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerAngleContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerAngleContributor(
  public var arg0: Float,
  public var `delegate`: MarkerDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setAngle(this, arg0)
  }
}
