...
@Immutable
private data class MarkerPositionModifierNode(
  private val arg0: LatLng,
  override var delegator: MarkerDelegate = NoOp,
) : MarkerModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    MarkerPositionContributionNode(arg0, delegator)
...
@Stable
private data class MarkerPositionContributionNode(
  public val arg0: LatLng,
  public val `delegate`: MarkerDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MarkerPositionContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MarkerPositionContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MarkerPositionContributor(
...
@Stable
public fun MarkerModifier.position(arg0: LatLng): MarkerModifier =
  this then MarkerPositionModifierNode(arg0)
