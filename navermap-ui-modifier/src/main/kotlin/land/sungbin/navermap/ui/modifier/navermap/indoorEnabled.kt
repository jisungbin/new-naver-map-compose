...
@Stable
private data class NaverMapIndoorEnabledModifierNode(
  private val arg0: Boolean,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapIndoorEnabledContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapIndoorEnabledContributionNode(
  public val arg0: Boolean,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapIndoorEnabledContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapIndoorEnabledContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapIndoorEnabledContributor(
  public var arg0: Boolean,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setIndoorEnabled(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.indoorEnabled(arg0: Boolean): NaverMapModifier =
  this then NaverMapIndoorEnabledModifierNode(arg0)
