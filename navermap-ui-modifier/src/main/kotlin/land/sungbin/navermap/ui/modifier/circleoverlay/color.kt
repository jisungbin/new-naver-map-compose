...
@Stable
private data class CircleOverlayColorContributionNode(
  public val arg0: Int,
  public val `delegate`: CircleOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = CircleOverlayColorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is CircleOverlayColorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class CircleOverlayColorContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun CircleOverlayModifier.color(arg0: Int): CircleOverlayModifier =
  this then CircleOverlayColorModifierNode(arg0)
