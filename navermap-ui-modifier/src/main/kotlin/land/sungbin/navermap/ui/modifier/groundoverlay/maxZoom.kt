...
@Stable
private data class GroundOverlayMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: GroundOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = GroundOverlayMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is GroundOverlayMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class GroundOverlayMaxZoomContributor(
...
@Stable
public fun GroundOverlayModifier.maxZoom(arg0: Double): GroundOverlayModifier =
  this then GroundOverlayMaxZoomModifierNode(arg0)
