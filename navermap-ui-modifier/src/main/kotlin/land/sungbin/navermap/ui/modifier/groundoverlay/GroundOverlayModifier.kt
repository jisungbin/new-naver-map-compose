...
public interface GroundOverlayModifier {
  ...
  public companion object : GroundOverlayModifier {
    ...
    override fun <R : Any> fold(initial: R, operation: (R, GroundOverlayModifier) -> R): R = initial

    override infix fun then(other: GroundOverlayModifier): GroundOverlayModifier = other

    override fun hashCode(): Int = identityHashCode(this)

    override fun equals(other: Any?): Boolean = this === other

    override fun toString(): String = "GroundOverlayModifier"
  }
}

@Stable
public class CombinedGroundOverlayModifier(
  private val outer: GroundOverlayModifier,
  private val `inner`: GroundOverlayModifier,
  ...
  override fun equals(other: Any?): Boolean = other is CombinedGroundOverlayModifier &&
