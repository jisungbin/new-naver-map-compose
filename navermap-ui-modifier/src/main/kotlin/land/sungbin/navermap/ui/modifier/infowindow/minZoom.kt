...
@Immutable
private data class InfoWindowMinZoomModifierNode(
  private val arg0: Double,
  override var delegator: InfoWindowDelegate = NoOp,
) : InfoWindowModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    InfoWindowMinZoomContributionNode(arg0, delegator)
...
@Stable
private data class InfoWindowMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: InfoWindowDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = InfoWindowMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is InfoWindowMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class InfoWindowMinZoomContributor(
...
@Stable
public fun InfoWindowModifier.minZoom(arg0: Double): InfoWindowModifier =
  this then InfoWindowMinZoomModifierNode(arg0)
