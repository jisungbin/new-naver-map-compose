...
@Stable
private data class LocationOverlayMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayMaxZoomContributor(
...
@Stable
public fun LocationOverlayModifier.maxZoom(arg0: Double): LocationOverlayModifier =
  this then LocationOverlayMaxZoomModifierNode(arg0)
