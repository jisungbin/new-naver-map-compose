...
@Stable
private data class NaverMapBuildingHeightModifierNode(
  private val arg0: Float,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapBuildingHeightContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapBuildingHeightContributionNode(
  public val arg0: Float,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapBuildingHeightContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapBuildingHeightContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapBuildingHeightContributor(
  public var arg0: Float,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setBuildingHeight(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.buildingHeight(arg0: Float): NaverMapModifier =
  this then NaverMapBuildingHeightModifierNode(arg0)
