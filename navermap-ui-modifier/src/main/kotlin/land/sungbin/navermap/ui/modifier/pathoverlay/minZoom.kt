...
@Stable
private data class PathOverlayMinZoomModifierNode(
  private val arg0: Double,
  override var delegator: PathOverlayDelegate = NoOp,
) : PathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    PathOverlayMinZoomContributionNode(arg0, delegator)
...
@Stable
private data class PathOverlayMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: PathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PathOverlayMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PathOverlayMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PathOverlayMinZoomContributor(
 ...
 */
@Stable
public fun PathOverlayModifier.minZoom(arg0: Double): PathOverlayModifier =
  this then PathOverlayMinZoomModifierNode(arg0)
