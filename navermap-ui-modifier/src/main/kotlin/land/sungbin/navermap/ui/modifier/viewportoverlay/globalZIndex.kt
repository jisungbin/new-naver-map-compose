...
@Stable
private data class ViewportOverlayGlobalZIndexModifierNode(
  private val arg0: Int,
  override var delegator: ViewportOverlayDelegate = NoOp,
) : ViewportOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    ViewportOverlayGlobalZIndexContributionNode(arg0, delegator)
...
@Stable
private data class ViewportOverlayGlobalZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: ViewportOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ViewportOverlayGlobalZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ViewportOverlayGlobalZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ViewportOverlayGlobalZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun ViewportOverlayModifier.globalZIndex(arg0: Int): ViewportOverlayModifier =
  this then ViewportOverlayGlobalZIndexModifierNode(arg0)
