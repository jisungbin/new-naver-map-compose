...
@Stable
private data class ArrowheadPathOverlayMaxZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayMaxZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayMaxZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ArrowheadPathOverlayMaxZoomContributor(
...
@Stable
public fun ArrowheadPathOverlayModifier.maxZoom(arg0: Double): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayMaxZoomModifierNode(arg0)
