...
private data class PolylineOverlayTagModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    PolylineOverlayTagContributionNode(arg0, delegator)
...
@Stable
private data class PolylineOverlayTagContributionNode(
  public val arg0: Any?,
  public val `delegate`: PolylineOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolylineOverlayTagContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolylineOverlayTagContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is PolylineOverlayTagContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class PolylineOverlayTagContributor(
  public var arg0: Any?,
