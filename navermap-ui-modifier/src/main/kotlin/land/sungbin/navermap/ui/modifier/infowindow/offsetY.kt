...
@Stable
private data class InfoWindowOffsetYModifierNode(
  private val arg0: Int,
  override var delegator: InfoWindowDelegate = NoOp,
) : InfoWindowModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    InfoWindowOffsetYContributionNode(arg0, delegator)
...
@Stable
private data class InfoWindowOffsetYContributionNode(
  public val arg0: Int,
  public val `delegate`: InfoWindowDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = InfoWindowOffsetYContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is InfoWindowOffsetYContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class InfoWindowOffsetYContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun InfoWindowModifier.offsetY(arg0: Int): InfoWindowModifier =
  this then InfoWindowOffsetYModifierNode(arg0)
