...
@Stable
private data class MultipartPathOverlayVisibleContributionNode(
  public val arg0: Boolean,
  public val `delegate`: MultipartPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MultipartPathOverlayVisibleContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayVisibleContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class MultipartPathOverlayVisibleContributor(
 ...
 */
@Stable
public fun MultipartPathOverlayModifier.visible(arg0: Boolean): MultipartPathOverlayModifier =
  this then MultipartPathOverlayVisibleModifierNode(arg0)
