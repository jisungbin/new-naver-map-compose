...
@Stable
private data class PolygonOverlayVisibleContributionNode(
  public val arg0: Boolean,
  public val `delegate`: PolygonOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolygonOverlayVisibleContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolygonOverlayVisibleContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolygonOverlayVisibleContributor(
 ...
 */
@Stable
public fun PolygonOverlayModifier.visible(arg0: Boolean): PolygonOverlayModifier =
  this then PolygonOverlayVisibleModifierNode(arg0)
