...
@Stable
private data class ArrowheadPathOverlayOutlineWidthModifierNode(
  private val arg0: Int,
  override var delegator: ArrowheadPathOverlayDelegate = NoOp,
) : ArrowheadPathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    ArrowheadPathOverlayOutlineWidthContributionNode(arg0, delegator)
...
@Stable
private data class ArrowheadPathOverlayOutlineWidthContributionNode(
  public val arg0: Int,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayOutlineWidthContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayOutlineWidthContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ArrowheadPathOverlayOutlineWidthContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun ArrowheadPathOverlayModifier.outlineWidth(arg0: Int): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayOutlineWidthModifierNode(arg0)
