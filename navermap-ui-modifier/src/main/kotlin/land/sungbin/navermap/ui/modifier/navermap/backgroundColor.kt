...
@Stable
private data class NaverMapBackgroundColorModifierNode(
  private val arg0: Int,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapBackgroundColorContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapBackgroundColorContributionNode(
  public val arg0: Int,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapBackgroundColorContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapBackgroundColorContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapBackgroundColorContributor(
  public var arg0: Int,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setBackgroundColor(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.backgroundColor(arg0: Int): NaverMapModifier =
  this then NaverMapBackgroundColorModifierNode(arg0)
