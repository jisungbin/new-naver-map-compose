...
@Stable
private data class InfoWindowGlobalZIndexModifierNode(
  private val arg0: Int,
  override var delegator: InfoWindowDelegate = NoOp,
) : InfoWindowModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    InfoWindowGlobalZIndexContributionNode(arg0, delegator)
...
@Stable
private data class InfoWindowGlobalZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: InfoWindowDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = InfoWindowGlobalZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is InfoWindowGlobalZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class InfoWindowGlobalZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun InfoWindowModifier.globalZIndex(arg0: Int): InfoWindowModifier =
  this then InfoWindowGlobalZIndexModifierNode(arg0)
