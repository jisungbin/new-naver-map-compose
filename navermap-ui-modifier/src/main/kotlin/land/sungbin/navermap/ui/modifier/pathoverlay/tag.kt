...
@Immutable
private data class PathOverlayTagModifierNode(
  private val arg0: Any?,
  override var delegator: PathOverlayDelegate = NoOp,
) : PathOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    PathOverlayTagContributionNode(arg0, delegator)
...
@Stable
private data class PathOverlayTagContributionNode(
  public val arg0: Any?,
  public val `delegate`: PathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PathOverlayTagContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PathOverlayTagContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is PathOverlayTagContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class PathOverlayTagContributor(
  public var arg0: Any?,
...
@Stable
public fun PathOverlayModifier.tag(arg0: Any?): PathOverlayModifier =
  this then PathOverlayTagModifierNode(arg0)
