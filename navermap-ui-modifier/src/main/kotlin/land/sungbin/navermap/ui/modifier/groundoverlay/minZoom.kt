...
@Stable
private data class GroundOverlayMinZoomContributionNode(
  public val arg0: Double,
  public val `delegate`: GroundOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = GroundOverlayMinZoomContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is GroundOverlayMinZoomContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class GroundOverlayMinZoomContributor(
...
@Stable
public fun GroundOverlayModifier.minZoom(arg0: Double): GroundOverlayModifier =
  this then GroundOverlayMinZoomModifierNode(arg0)
