...
@Stable
private data class ArrowheadPathOverlayCoordsModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    ArrowheadPathOverlayCoordsContributionNode(arg0, delegator)
...
@Stable
private data class ArrowheadPathOverlayCoordsContributionNode(
  public val arg0: List<LatLng>,
  public val `delegate`: ArrowheadPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = ArrowheadPathOverlayCoordsContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is ArrowheadPathOverlayCoordsContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class ArrowheadPathOverlayCoordsContributor(
 ...
 */
@Stable
public fun ArrowheadPathOverlayModifier.coords(arg0: List<LatLng>): ArrowheadPathOverlayModifier =
  this then ArrowheadPathOverlayCoordsModifierNode(arg0)
