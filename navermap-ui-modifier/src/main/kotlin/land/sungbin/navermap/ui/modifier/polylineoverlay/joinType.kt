...
private data class PolylineOverlayJoinTypeModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    PolylineOverlayJoinTypeContributionNode(arg0, delegator)
...
@Stable
private data class PolylineOverlayJoinTypeContributionNode(
  public val arg0: PolylineOverlay.LineJoin,
  public val `delegate`: PolylineOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PolylineOverlayJoinTypeContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PolylineOverlayJoinTypeContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PolylineOverlayJoinTypeContributor(
  public var arg0: PolylineOverlay.LineJoin,
  public var `delegate`: PolylineOverlayDelegate,
) : OverlayContributor {
  override fun Any.contribute() {
    delegate.setJoinType(this, arg0)
  }
}
