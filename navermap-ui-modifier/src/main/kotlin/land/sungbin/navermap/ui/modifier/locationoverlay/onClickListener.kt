...
private data class LocationOverlayOnClickListenerModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    LocationOverlayOnClickListenerContributionNode(arg0, delegator)
...
@Stable
private data class LocationOverlayOnClickListenerContributionNode(
  ...
  override fun create(): Contributor = LocationOverlayOnClickListenerContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayOnClickListenerContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is LocationOverlayOnClickListenerContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class LocationOverlayOnClickListenerContributor(
