...
private data class PathOverlayHideCollidedCaptionsModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    PathOverlayHideCollidedCaptionsContributionNode(arg0, delegator)
...
@Stable
private data class PathOverlayHideCollidedCaptionsContributionNode(
  public val arg0: Boolean,
  public val `delegate`: PathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = PathOverlayHideCollidedCaptionsContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is PathOverlayHideCollidedCaptionsContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class PathOverlayHideCollidedCaptionsContributor(
