...
@Stable
private data class LocationOverlayZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: LocationOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = LocationOverlayZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is LocationOverlayZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class LocationOverlayZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun LocationOverlayModifier.zIndex(arg0: Int): LocationOverlayModifier =
  this then LocationOverlayZIndexModifierNode(arg0)
