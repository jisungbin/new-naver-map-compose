...
@Immutable
private data class MultipartPathOverlayMapModifierNode(
  ...
  override fun getContributionNode(): MapModifierContributionNode =
    MultipartPathOverlayMapContributionNode(arg0, delegator)
...
@Stable
private data class MultipartPathOverlayMapContributionNode(
  public val arg0: NaverMap?,
  public val `delegate`: MultipartPathOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = MultipartPathOverlayMapContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is MultipartPathOverlayMapContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }

  override fun onDetach(instance: Contributor) {
    require(instance is MultipartPathOverlayMapContributor)
    instance.clear?.invoke()
    instance.clear = null
  }
}

private class MultipartPathOverlayMapContributor(
...
@Stable
public fun MultipartPathOverlayModifier.map(arg0: NaverMap?): MultipartPathOverlayModifier =
  this then MultipartPathOverlayMapModifierNode(arg0)
