...
@Stable
private data class NaverMapSymbolScaleModifierNode(
  private val arg0: Float,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapSymbolScaleContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapSymbolScaleContributionNode(
  public val arg0: Float,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapSymbolScaleContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapSymbolScaleContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapSymbolScaleContributor(
  public var arg0: Float,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setSymbolScale(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.symbolScale(arg0: Float): NaverMapModifier =
  this then NaverMapSymbolScaleModifierNode(arg0)
