...
@Stable
private data class NaverMapLiteModeEnabledModifierNode(
  private val arg0: Boolean,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapLiteModeEnabledContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapLiteModeEnabledContributionNode(
  public val arg0: Boolean,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapLiteModeEnabledContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapLiteModeEnabledContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapLiteModeEnabledContributor(
  public var arg0: Boolean,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setLiteModeEnabled(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.liteModeEnabled(arg0: Boolean): NaverMapModifier =
  this then NaverMapLiteModeEnabledModifierNode(arg0)
