...
@Stable
private data class CircleOverlayGlobalZIndexModifierNode(
  private val arg0: Int,
  override var delegator: CircleOverlayDelegate = NoOp,
) : CircleOverlayModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    CircleOverlayGlobalZIndexContributionNode(arg0, delegator)
...
@Stable
private data class CircleOverlayGlobalZIndexContributionNode(
  public val arg0: Int,
  public val `delegate`: CircleOverlayDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = CircleOverlayGlobalZIndexContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is CircleOverlayGlobalZIndexContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class CircleOverlayGlobalZIndexContributor(
  public var arg0: Int,
 ...
 */
@Stable
public fun CircleOverlayModifier.globalZIndex(arg0: Int): CircleOverlayModifier =
  this then CircleOverlayGlobalZIndexModifierNode(arg0)
