...
@Stable
private data class NaverMapDefaultCameraAnimationDurationModifierNode(
  private val arg0: Int,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapDefaultCameraAnimationDurationContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapDefaultCameraAnimationDurationContributionNode(
  public val arg0: Int,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapDefaultCameraAnimationDurationContributor(
    arg0,
    delegate,
  )

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapDefaultCameraAnimationDurationContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapDefaultCameraAnimationDurationContributor(
  public var arg0: Int,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setDefaultCameraAnimationDuration(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.defaultCameraAnimationDuration(arg0: Int): NaverMapModifier =
  this then NaverMapDefaultCameraAnimationDurationModifierNode(arg0)
