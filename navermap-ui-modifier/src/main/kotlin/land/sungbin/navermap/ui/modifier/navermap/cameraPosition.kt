...
@Stable
private data class NaverMapCameraPositionModifierNode(
  private val arg0: CameraPosition,
  override var delegator: NaverMapDelegate = NoOp,
) : NaverMapModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    NaverMapCameraPositionContributionNode(arg0, delegator)
...
@Stable
private data class NaverMapCameraPositionContributionNode(
  public val arg0: CameraPosition,
  public val `delegate`: NaverMapDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = NaverMap

  override fun create(): Contributor = NaverMapCameraPositionContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is NaverMapCameraPositionContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class NaverMapCameraPositionContributor(
  public var arg0: CameraPosition,
  public var `delegate`: NaverMapDelegate,
) : NaverMapContributor {
  override fun Any.contribute() {
    delegate.setCameraPosition(this, arg0)
  }
}
 ...
 */
@Stable
public fun NaverMapModifier.cameraPosition(arg0: CameraPosition): NaverMapModifier =
  this then NaverMapCameraPositionModifierNode(arg0)
