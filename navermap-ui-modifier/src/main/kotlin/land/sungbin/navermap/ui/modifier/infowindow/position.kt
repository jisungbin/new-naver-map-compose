...
@Stable
private data class InfoWindowPositionModifierNode(
  private val arg0: LatLng,
  override var delegator: InfoWindowDelegate = NoOp,
) : InfoWindowModifier {
  override fun getContributionNode(): MapModifierContributionNode =
    InfoWindowPositionContributionNode(arg0, delegator)
...
@Stable
private data class InfoWindowPositionContributionNode(
  public val arg0: LatLng,
  public val `delegate`: InfoWindowDelegate = NoOp,
) : MapModifierContributionNode {
  override val kindSet: ContributionKind = Overlay

  override fun create(): Contributor = InfoWindowPositionContributor(arg0, delegate)

  override fun update(contributor: Contributor) {
    require(contributor is InfoWindowPositionContributor)
    contributor.arg0 = arg0
    contributor.delegate = delegate
  }
}

private class InfoWindowPositionContributor(
 ...
 */
@Stable
public fun InfoWindowModifier.position(arg0: LatLng): InfoWindowModifier =
  this then InfoWindowPositionModifierNode(arg0)
